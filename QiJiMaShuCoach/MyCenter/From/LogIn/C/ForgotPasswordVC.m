...
- (void)CreatingControls {
    ...
    _NameIBV.sd_layout.leftSpaceToView(self.view, 0).topSpaceToView(self.view, kFit(100)).rightSpaceToView(self.view, 0).heightIs(kFit(55));
...
- (void)handlesubmitBtn {
    ...
    NSString *URL_Str = [NSString stringWithFormat:@"%@/coach/api/setPwd", kURL_SHY];
    NSMutableDictionary *URL_Dic = [NSMutableDictionary dictionary];
    URL_Dic[@"password"] = _passWordIBV.NameTF.text;
